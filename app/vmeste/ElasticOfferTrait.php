...
trait ElasticOfferTrait {
    ...
    public static function search(Array $body)
    {
        ...
        return new \Fadion\Bouncy\ElasticCollection($response, $instance);
    }
    ...
    public function getBody() {
        ...
        $body['days'] = $days;
        $body['user']['id'] = $this->user->id;
        $body['user']['gender'] = $this->user->gender;
        $body['user']['first_name'] = $this->user->first_name;
        $body['user']['last_name'] = $this->user->last_name;
        $body['user']['address'] = $this->user->address;
        $body['user']['location']['lat'] = $this->user->address_latitude;
        $body['user']['location']['lon'] = $this->user->address_longitude;
